...
Ext.define('Ext.ux.grid.filter.DateFilter', {
    ...
    pickerOpts : {
        ...
        selectToday: function() {
            ...
            if(btn && !btn.disabled){
               /* При выборе "Нет даты" сетим значение начала эпохи
                * Данное значение является null для фильтра по датам.
                * Данное решение использовано т.к. datepicker не может вернуть null
				* bug report:
				* http://www.sencha.com/forum/showthread.php?265960-Datepicker-datepickerfield-does-not-allow-setting-null-values
                */
                me.setValue(new Date(null));
